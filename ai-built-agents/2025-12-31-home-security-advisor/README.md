...
## Summary
The Home Security Advisor is an AI agent that evaluates the security of your home based on crime data specific to your location, providing tailored security advice.
