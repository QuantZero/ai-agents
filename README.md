...
**New agents are automatically built daily** by the [Agent Builder Agent](./agent-builder-agent/README.md) and added to the [`ai-built-agents`](./ai-built-agents/) directory.
...
Agents in the [`ai-built-agents`](./ai-built-agents/) directory are automatically generated by the Agent Builder. See the [ai-built-agents README](./ai-built-agents/README.md) for the complete list.
...
[📖 Read the Daily Focus Enhancer README](./ai-built-agents/2025-12-26-daily-focus-enhancer/README.md)
...
[📖 Read the Smart Meal Planner README](./ai-built-agents/2025-12-26-smart-meal-planner/README.md)
